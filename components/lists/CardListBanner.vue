  ...
  <UModal v-model:open="isEditBannerModalOpen" title="Change Banner Image"
    ...
    <template #content>
      <div class="p-4 space-y-4">
        ...
        <USelectMenu v-model="selectedBannerCard" v-model:search-term="searchTerm" :loading="bannerUpdateLoading"
          :items="filteredBannerCards" placeholder="Search for a card..." icon="i-lucide-search" class="w-full" />
