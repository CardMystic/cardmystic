  ...
  >
    <UContainer class="py-6 text-left">
      ...
      <div class="flex justify-center items-start gap-4 mb-4">
        <NuxtLink
          to="https://github.com/CardMystic"
          target="_blank"
          aria-label="GitHub"
          rel="noopener"
        >
        ...
        <NuxtLink
          to="https://www.youtube.com/@cardmystic"
          target="_blank"
          aria-label="YouTube"
          rel="noopener"
        >
      ...
      <!-- Disclaimer -->
      <div
        class="text-xs text-white dark:text-gray-400 space-y-1 max-w-6xl mx-auto leading-relaxed"
      >
        <p>
