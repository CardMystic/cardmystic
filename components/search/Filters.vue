    ...
    <div v-if="hasActiveFilters" class="active-filters-section mb-4">
      <div class="active-filters-chips">
        ...
        <v-chip
          ...
          size="small"
          class="ma-1"
          @click:close="removeCardType(cardType)"
        >
          {{ cardType }}
        </v-chip>
        ...
        <v-chip
          ...
          size="small"
          class="ma-1"
          @click:close="removeRarity(rarity)"
        >
          {{ rarity }}
        </v-chip>
        ...
        <v-chip
          ...
          size="small"
          class="ma-1"
          @click:close="clearColorFilterOption"
        >
        ...
        >
          <v-chip
            v-if="formatItem.format || formatItem.status"
            closable
            color="success"
            variant="outlined"
            size="small"
            class="ma-1"
            @click:close="removeFormat(index)"
          >
            ...
            <v-expansion-panel-text>
              ...
              <div class="color-checkboxes">
                <v-checkbox
                  ...
                  :key="color"
                  :label="color"
                  :model-value="isColorSelected(color)"
                  @update:model-value="(value) => toggleColor(color, value)"
                  color="primary"
                  density="compact"
                  hide-details
                >
            ...
            <v-expansion-panel-text>
              <div class="rarity-checkboxes">
                <v-checkbox
                  ...
                  :key="rarity"
                  :label="rarity"
                  :model-value="isRaritySelected(rarity)"
                  @update:model-value="(value) => toggleRarity(rarity, value)"
                  color="primary"
                  density="compact"
                  hide-details
                />
...
const hasActiveFilters = computed(() => {
  ...
  return !!(
    ...
    (filters.selectedColorFilterOption &&
      filters.selectedColorFilterOption !== 'Contains At Least') ||
