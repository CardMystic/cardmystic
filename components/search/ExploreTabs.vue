  ...
  <div class="flex gap-3 max-md:hidden mb-4 justify-center flex-nowrap">
    <button
      ...
      :class="[
        ...
        { active: statsType === 'popular-cards' },
      ]"
    ...
    <button
      ...
      :class="[
        'search-tab-button-new',
        { active: statsType === 'popular-commanders' },
      ]"
    ...
    <button
      ...
      :class="[
        'search-tab-button-new',
        { active: statsType === 'popular-by-commander' },
      ]"
...
const statsIcon = computed(() => {
  if (props.statsType === 'popular-cards')
    return 'i-lucide-chart-no-axes-combined';
...
const mobileValue = computed(() =>
  props.cardActive ? '_card' : props.statsType,
);
