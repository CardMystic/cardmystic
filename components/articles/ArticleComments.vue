    ...
    <ClientOnly>
      <div v-if="isLoggedIn" class="mb-6 space-y-2">
        <UTextarea
          ...
          :rows="3"
          :maxlength="ARTICLE_COMMENT_MAX_CHARS"
          class="w-full"
        />
...
import { useArticleComments } from '~/composables/useArticleSocial';
import { useUserProfile } from '~/composables/useUserProfile';
import { formatShortDate } from '~/utils/dateFormatter';
import { useToast } from '#imports';
import {
  ARTICLE_COMMENT_MAX_CHARS,
  type ArticleComment,
...
const props = defineProps({
  ...
  /** Whether the viewer wrote the article (authors may delete any comment). */
  isArticleOwner: {
    type: Boolean,
    default: false,
  },
