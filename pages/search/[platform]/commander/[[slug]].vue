  ...
  <UContainer class="mb-6 px-0 max-w-full">
    <div class="w-full flex flex-col items-center">
      <SearchSEOTitleAndDescription
        :seo-entry="seoEntry"
        fallback-title="MTG Commander Search"
        fallback-description="Search for commanders using semantic natural language vector search."
      />

      <Search
        default-search-type="commander"
        ...
        <SearchResults
          ...
          :help-text="
            seoEntry
              ...
              : `Please describe the ${platformName} commander you're looking for.`
          "
        />
      </div>
    </div>
